...
public class PanelExpendedor extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        //entrada de moneda
        g2.drawRect(357, 365, 106, 41);
        txtEntradaM.setBounds(360, 368, 100, 35);
        ...
        g.setColor(Color.black);
        g.fillRect(390, 418, 40, 100);
        g.setColor(Color.GRAY);
        g.fillRect(395, 423, 30, 90);
        g.setColor(Color.WHITE);
        g.fillRect(405, 430, 10, 76);
        ...
        switch (seleccionM){
            case MONEDA100 -> {
                ...
                g.drawImage(imMoneda,420,430,76,76,this);
            }
            case MONEDA500 -> {
